...
const Promotion = () => {
  ...
  return (
    <>
        <Navbar />
      <div className="bg-black" id="promotion">
        <div className="introduction mt-28 ">
          <div
            className="title text-center text-2xl font-[800] uppercase py-3"
            style={textBackground}
          >
            Promotional Advertisement
          </div>
          <div className="relatedText text-center text-lg px-8 py-3 text-amber-100">
          Create impactful promotional advertisements from your text with ease. Our tool converts your content into compelling ads that grab attention and drive action.
          </div>
        </div>
