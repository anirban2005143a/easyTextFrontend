...
const Paragraph = () => {
  ...
  return (
    <>
       <Navbar />
      <div className="bg-black" id="paragraph">
        <div className="introduction mt-28 ">
          ...
          Easily transform your text into well-structured paragraphs. Our tool organizes your content into clear, coherent paragraphs, enhancing readability and flow.
          </div>
        </div>
